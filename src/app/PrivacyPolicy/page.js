...
export default function PrivacyPolicy({ onBackHome }) {
  // Simple layout staggering animations
      ...
      >
        ...
        <motion.div variants={itemVariants} className="border-b border-outline-variant pb-6 mb-8">
          <div className="flex items-center gap-3 mb-4">
            <span className="material-symbols-outlined text-primary text-[32px]">shield_health</span>
        ...
        <div className="space-y-8">
          ...
          <motion.p variants={itemVariants} className="font-body-lg text-body-lg text-on-surface-variant leading-relaxed">
            At <strong className="text-primary font-bold">Medsminder</strong>, we are committed to protecting your medical and personal data. This policy outlines how we handle information when you use our AI prescription analyzer tool.
          </motion.p>
            ...
            <ul className="list-none p-0 m-0 space-y-3 pl-2">
              <li className="flex items-start gap-3">
                ...
                <p className="font-body-md text-on-surface-variant m-0">
                  <strong className="text-primary font-semibold">Prescription Images:</strong> Any photos of prescriptions you upload are processed instantly in real-time by our secure AI engine to extract medication details.
                </p>
              </li>
              <li className="flex items-start gap-3">
                <span className="material-symbols-outlined text-secondary shrink-0 mt-0.5">check_circle</span>
                <p className="font-body-md text-on-surface-variant m-0">
                  <strong className="text-primary font-semibold">No Permanent Storage:</strong> Uploaded prescription images are used solely for extraction and are immediately discarded. We do not store your medical documents on our servers.
                </p>
              </li>
            </ul>
          </motion.section>
          ...
          <motion.section variants={itemVariants} className="space-y-4">
            ...
            <p className="font-body-md text-on-surface-variant leading-relaxed pl-2 m-0">
              We use industry-standard encryption protocol layers to safeguard data transmission. Your healthcare details are strictly confidential, heavily protected, and legally guarded.
            </p>
          </motion.section>

          {/* Section 3 */}
          <motion.section variants={itemVariants} className="bg-surface-container-low/50 border border-outline-variant p-6 rounded-2xl space-y-4">
            <h3 className="font-headline-md text-headline-md text-primary font-bold tracking-tight flex items-center gap-2 m-0">
            ...
            <p className="font-body-md text-on-surface-variant leading-relaxed m-0">
              If you have any questions about your data privacy, please contact us directly:
            </p>
            <div className="pt-2">
              <motion.a 
                whileHover={{ x: 2 }}
        ...
        {/* Micro-Disclaimer / Legal Footer stamp */}
        <motion.div 
