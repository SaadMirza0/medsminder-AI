    ...
    <div className="min-h-screen bg-surface-container-low text-on-surface py-12 px-4 md:px-margin-desktop">
      ...
      >
        ...
        <div className="space-y-8">
          ...
          >
            Welcome to{" "}
            <strong className="text-primary font-bold">Medsminder</strong>. By
            using our website and AI tools, you agree to follow the simple rules
            outlined below.
          </motion.p>

          <motion.section
            variants={itemVariants}
            className="bg-error-container/10 border border-error-container/30 p-6 rounded-2xl space-y-4"
          >
            ...
            <div className="space-y-3 pl-2">
              <div className="flex items-start gap-3">
                ...
                <p className="font-body-md text-on-surface-variant m-0">
                  ...
                  Medsminder uses AI to read messy handwriting. It is built for
                  demonstration purposes and cannot replace professional medical
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="font-body-md text-on-surface-variant m-0">
                  ...
                  Always verify the AI results with a certified pharmacist or
                  medical professional before taking or handing out any
                  prescription drugs.
                </p>
              </div>
            </div>
          ...
          <motion.section variants={itemVariants} className="space-y-4">
            ...
            <p className="font-body-md text-on-surface-variant leading-relaxed pl-2 m-0">
              You agree to use this platform responsibly and legally. You must
              only upload photos of prescriptions that belong to you, or that
              you have explicit legal permission to possess and analyze.
            </p>
          </motion.section>
          ...
          <motion.section variants={itemVariants} className="space-y-4">
            ...
            <p className="font-body-md text-on-surface-variant leading-relaxed pl-2 m-0">
              This application is provided completely{" "}
              <strong className="font-semibold text-primary">"as is."</strong>{" "}
              Because AI models can occasionally make mistakes, the developer
              and platform are not responsible for any medical errors, wrong
              dosages, or problems caused by relying on the automated results.
            </p>
          </motion.section>

          <motion.section
            variants={itemVariants}
            className="bg-surface-container-low border border-outline-variant p-6 rounded-2xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4"
          >
            <div>
              <h4 className="font-headline-md text-base text-primary font-bold m-0 mb-1">
                Have questions about these rules?
              </h4>
              <p className="font-body-sm text-body-sm text-on-surface-variant m-0">
                We respond to support queries within 10 minutes.
              </p>
            </div>
            <motion.a
